...
| 可追溯的图片搜索、物化与页面背景策略 | `PPT-ASSET-002`、`PPT-BG-001/002/004`、`PPT-SKILL-002/003/004/005/006/007` | 2026-08-21 至 2026-09-05 | 图片检索词在规划期确定，素材落盘至任务工作区，背景按页面类型复用并在渲染前校验；`search_images` 候选字段与独立 Unsplash CLI 对齐，CLI 会物化前景 image 组件和已选候选；不再依赖旧 Visual Designer 本地背景主题。 |
