...
Define the offline visual asset, provenance, semantic selection, background catalog, and editable content-photo contract used by the Visual Designer generators.
...
- **THEN** all curated icons, backgrounds, content photos, and patterns SHALL exist at stable paths and both manifests SHALL match the downloaded files
