# versioned-benchmark-dataset-sync Specification

## Purpose

Publish reviewed online evidence as immutable benchmark datasets and verify private local imports before use.
