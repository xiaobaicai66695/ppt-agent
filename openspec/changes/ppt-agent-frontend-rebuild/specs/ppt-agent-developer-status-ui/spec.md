...
- **THEN** the Dashboard surfaces a compact warning summary near the user workflow
- **AND** detailed runtime data remains available by expanding diagnostics
- **AND** normal download, preview, and continuation actions remain available
