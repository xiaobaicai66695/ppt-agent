...
- [x] 1.3 Enforce visual asset validation from standalone validation and full-ppt render entry points; update examples and references.
...
- [x] 3.1 Run standalone unit/render smoke tests, backend focused tests, and offline gold PPTSpec benchmark.
