...
type (
	...
	EvaluationArtifact       = model.EvaluationArtifact
	EvaluationStageRun       = model.EvaluationStageRun
	EvaluationCandidate      = model.EvaluationCandidate
	EvaluationCaseRevision   = model.EvaluationCaseRevision
	EvaluationDatasetVersion = model.EvaluationDatasetVersion
	EvaluationDatasetMember  = model.EvaluationDatasetMember
	EvaluationExport         = model.EvaluationExport
)
