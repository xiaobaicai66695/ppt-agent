...
// VisualPolicy declares whether this ppt requires external visual assets.
...
type ContentPlan struct {
	...
	EvidenceRefs  []string        `json:"evidence_refs,omitempty"`  // refs into ppt-level content_bank for granular repair
