...
.trace-card{position:relative;overflow:hidden;border:1px solid var(--border-subtle);border-left-width:3px;border-radius:8px;background:var(--surface-accent)}.trace-card::before{position:absolute;top:-17px;bottom:100%;left:15px;width:1px;background:var(--border-strong);content:''}.thought-card{border-left-color:var(--text-subtle)}.tool-pair-card.running{border-left-color:var(--info)}.tool-pair-card.success{border-left-color:var(--accent)}.tool-pair-card.error{border-left-color:var(--danger)}
...
.trace-detail{display:grid;gap:10px;padding:10px 12px;border-top:1px solid var(--border-subtle);color:var(--text-muted);background:color-mix(in srgb,var(--surface-raised) 88%,transparent);font-size:12px;line-height:1.65}.thought-detail p,.detail-copy{margin:0;white-space:pre-wrap;overflow-wrap:anywhere}.detail-copy span{display:block;margin-bottom:2px}.tool-call-panel,.tool-result-panel{display:grid;gap:7px}.payload-block{min-width:0}.payload-block>span{display:block;margin-bottom:4px}.payload-block pre,.tool-result-pre{margin:0;padding:9px 10px;border:1px solid var(--border-subtle);border-radius:6px;color:var(--text-strong);background:var(--surface-raised);font:400 11px/1.55 'DM Mono',monospace;white-space:pre-wrap;overflow-wrap:anywhere}.payload-block pre{max-height:220px;overflow:auto;scrollbar-gutter:stable}.tool-result-panel{padding:10px;border:1px solid var(--border-subtle);border-radius:7px;background:var(--surface-base)}.tool-result-head{display:flex;align-items:center;justify-content:space-between;gap:10px;color:var(--text-subtle);font:500 10px 'DM Mono',monospace;letter-spacing:.06em}.tool-result-pre{max-height:240px;overflow:auto;scrollbar-gutter:stable;white-space:pre-wrap}.streaming-mark{display:inline-flex;align-items:center;width:max-content;color:var(--accent)}.streaming-mark::before{width:5px;height:5px;margin-right:5px;border-radius:50%;background:currentColor;content:''}.tool-image-preview{display:flex;gap:8px;overflow:auto;padding-bottom:2px}.tool-image-preview a{display:grid;gap:3px;min-width:136px;color:var(--text-muted);font-size:10px;line-height:1.35}.tool-image-preview img{display:block;width:136px;height:88px;border:1px solid var(--border-subtle);border-radius:4px;object-fit:cover;background:var(--surface-hover)}.tool-image-preview a:focus-visible{outline:2px solid var(--accent);outline-offset:2px}
