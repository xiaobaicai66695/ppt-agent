#!/usr/bin/env python3
"""Validate a standalone ppt-planner tasks.json before rendering."""
...
def main() -> int:
    ...
    contract_path = skills_dir / "ppt-planner" / "templates" / "component_contracts.json"
...
def print_human(result_value: dict[str, Any]) -> None:
    if result_value["ok"]:
        print("PPTSpec validation passed")
        return
    print(f"PPTSpec validation failed: {result_value['error_count']} errors")
