...
def generate(
    ...
    for i, r in enumerate(results[:4]):
        ...
        add_text(
            ...
            left=mx + 0.12, top=my + 0.1, width=metric_w - 0.24, height=0.38,
        ...
        add_text(
            ...
            left=mx + 0.12, top=my + 0.5, width=metric_w - 0.24, height=0.22,
        ...
        add_text(
            ...
            left=mx + 0.12, top=my + 0.72, width=metric_w - 0.24, height=0.22,
