...
def generate(
    ...
    if direction == "horizontal":
        ...
        for i, step in enumerate(visible_steps):
            ...
            add_rect(
                slide,
                left=x, top=axis_y - box_h / 2, width=box_w, height=0.08,
            ...
            add_text(
                slide,
                text=num,
                left=x + 0.1, top=axis_y - box_h / 2 + 0.15, width=box_w - 0.2, height=0.4,
        ...
        for i, step in enumerate(visible_steps):
            ...
            add_rect(
                slide,
                left=start_x, top=y, width=box_w, height=0.06,
                fill_color="primary", palette=palette,
            )
            ...
            add_text(
                slide,
                text=num,
                left=start_x + 0.15, top=y + 0.15, width=0.6, height=0.4,
                font_size=16, bold=True,
                color="primary", alignment="left",
                palette=palette,
            )
